...
-- All user themes are located inside the $HOME/.config/awesome/themes/ directory.
-- So, when you wanna choose specific theme, you have to update only theme_name field.
config_path = os.getenv("HOME") .. "/.config/awesome/"
theme_name = "multicolor"
theme_path = config_path .. "themes/" .. theme_name .. "/theme.lua"
...
awful.screen.connect_for_each_screen(function(s)
  ...
  awful.tag({ "www", "ide", "term", "doc", "media", "chat" }, s, awful.layout.layouts[2])
...
globalkeys = gears.table.join(
  ...
  -- Brightness Keys
  -- Available via the `xbacklight` package
